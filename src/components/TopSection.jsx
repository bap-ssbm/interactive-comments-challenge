...
function topBtns(props){
    ...
    if(props.isUser){
        return(
            ...
            <button className="delete-btn" name={props.id} onClick={props.deleteModal}>
            ...
            <button className="reply-btn"  name={props.userName} value={props.id} onClick = {props.editBtn}>
        ...
        return(
            <div className="top-section-btns">
            <button className="reply-btn" onClick={props.replyBtn} name={props.userName} value={props.id}>
